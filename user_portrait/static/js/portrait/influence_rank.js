...
function draw_hot_users_details(uid){
    ...
    html_details += '<thead><tr><th colspan="2"></th><th style="text-align:center;vertical-align:middle;width:60px">总数</th><th style="text-align:center;vertical-align:middle;width:60px">平均数</th><th style="text-align:center;vertical-align:middle;width:60px">最大值</th><th style="text-align:center;vertical-align:middle;width:60px">爆发度</th></tr></thead>';
    html_details += '<tbody>';
    html_details += '<tr>';
    html_details += '<td class="center" style="text-align:center;vertical-align:middle" rowspan="2">原创微博</td>';
    html_details += '<td class="center" style="text-align:center;vertical-align:middle">转发</td>';
    ...
    html_details += '</tr>';
    html_details += '<tr>';
    html_details += '<td class="center" style="text-align:center;vertical-align:middle" rowspan="2">转发微博</td>';
    html_details += '<td class="center" style="text-align:center;vertical-align:middle">转发</td>';
